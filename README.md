...
[![Build Status](https://travis-ci.org/valeriansaliou/raider.svg?branch=master)](https://travis-ci.org/valeriansaliou/raider) [![Buy Me A Coffee](https://img.shields.io/badge/buy%20me%20a%20coffee-donate-yellow.svg)](https://www.buymeacoffee.com/valeriansaliou)
...
_Tested at Rust version: `rustc 1.46.0-nightly (16957bd4d 2020-06-30)`_
...
```bash
docker pull valeriansaliou/raider:v1.1.2
```
...
```bash
docker run -p 8080:8080 -v /path/to/your/raider/config.cfg:/etc/raider.cfg valeriansaliou/raider:v1.1.2
```
